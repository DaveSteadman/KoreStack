...
This document defines the layout and UI structure of KoreChat.

KoreChat is the conversation-state management service. Its UI is a developer/operator debug console — it exposes a direct view into conversation records, messages, events, and state for inspection and manual intervention.
...
KoreChat uses the shared KoreStack shell from UIElements.
...
│  KoreChat brand  │  status dot  │  API chip  │  filters     │
│                          │  [New] [Refresh] [Auto □]                │
└─────────────────────────────────────────────────────────────────────┘
```
