...
Endpoints used:
    KoreReference: GET http://127.0.0.1:8624/articles?offset=N&limit=100
                   GET http://127.0.0.1:8624/articles/{title}/links
                   GET http://127.0.0.1:8624/articles/{title}  (with --facts*)
