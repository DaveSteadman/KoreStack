...
def _get_koreconversation_base_url() -> str | None:
    # Prefer the live sidecar setting, but fall back to default.json so the UI link
    # still works when KoreConversation is configured but managed externally.
...
def redirect_to_koreconversation_ui():
    base_url = _get_koreconversation_base_url()
