...
def plan_create(objective: str, initial_tasks: list[object] | None = None) -> str:
...
def plan_get_task(task_id: str) -> str:
...
def plan_add_task(title: str, description: str = "", instruction: str = "", depends_on: list[str] | None = None) -> str:
    return _json(_summary(add_simple_task(title=title, description=description, instruction=instruction, depends_on=depends_on)))


def plan_update_task(task_id: str, title: str | None = None, description: str | None = None, instruction: str | None = None, depends_on: list[str] | None = None) -> str:
