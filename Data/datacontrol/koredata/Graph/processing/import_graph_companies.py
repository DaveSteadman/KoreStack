...
# - _is_company_candidate: Implements the  is company candidate operation for this module.
# - _is_confirmed_company: Implements the  is confirmed company operation for this module.
