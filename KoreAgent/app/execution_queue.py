...
# MARK: OVERVIEW
# ====================================================================================================
# Shared prompt-execution queue for KoreAgent.
#
# Provides:
...
class TaskQueue:
    ...
    def run_lock(self) -> threading.Lock:
        """The raw serialisation lock for coordinated queue access."""
    ...
    def _worker_loop(self) -> None:
        while not self._shutdown.is_set():
            ...
            while not self._shutdown.is_set():
                ...
                # Coordinate with any external holder, then re-check for shutdown.
                with self._run_lock:
...
# ====================================================================================================
# task_queue is the shared singleton used by server-side prompt execution.
