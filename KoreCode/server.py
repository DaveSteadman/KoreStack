...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--host', default=os.environ.get('KORECODE_HOST', '127.0.0.1'))
    parser.add_argument('--port', type=int, default=int(os.environ.get('KORECODE_PORT', '5600')))
