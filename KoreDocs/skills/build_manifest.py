...
def build_manifest() -> dict:
    ...
    return {
        ...
        "skills": [{
            "name":                  "koredocs",
            "purpose":               "Create, edit, search, or inspect persistent KoreDocs documents, spreadsheets, and diagrams.",
            "selection_description": "Use only when the user asks to create, edit, search, inspect, or save a KoreDocs document, spreadsheet, or diagram. Do not select for an ordinary report, email, HTML response, or Working Data synthesis that does not need a KoreDocs file.",
