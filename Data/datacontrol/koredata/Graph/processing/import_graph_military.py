...
# - _is_platform_candidate: Implements the  is platform candidate operation for this module.
# - _is_confirmed_platform: Implements the  is confirmed platform operation for this module.
